...
Shader "Modular Bricks/Cubes/Diffuse Color Transparent" {
	Properties{
	...
	SubShader{
		...
		Pass{
			...
			void geom(triangle Input p[3], inout TriangleStream<Interpolators> triStream)
			{
				...
				triStream.Append(CreateInterpolator(p[1].vertex, p[1].normal));
				triStream.Append(CreateInterpolator(p[2].vertex, p[2].normal));
				...
				if ((triangleNormal / 3).y > 0.98)
				{
					...
					// desenam baza
					// prima fata
					triStream.Append(CreateInterpolator(vertices_down[0], normal_45));
					triStream.Append(CreateInterpolator(vertices_up[0], normal_45));
					triStream.Append(CreateInterpolator(vertices_down[1], normal_45));
					triStream.Append(CreateInterpolator(vertices_up[1], normal_45));
					triStream.RestartStrip();
					// a doua fata
					triStream.Append(CreateInterpolator(vertices_down[1], normal_135));
					triStream.Append(CreateInterpolator(vertices_up[1], normal_135));
					triStream.Append(CreateInterpolator(vertices_down[2], normal_135));
					triStream.Append(CreateInterpolator(vertices_up[2], normal_135));
				}
			}
